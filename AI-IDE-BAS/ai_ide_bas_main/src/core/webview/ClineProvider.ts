	...
	*/
	...
	private async getHMRHtmlContent(webview: vscode.Webview): Promise<string> {
		...
		const csp = [
			...
			`connect-src ${webview.cspSource} https://* https://*.posthog.com https://api-test.aiidebas.com https://api.aiidebas.com ws://${localServerUrl} ws://0.0.0.0:${localPort} http://${localServerUrl} http://0.0.0.0:${localPort} http://localhost:8000 http://127.0.0.1:8000`,
		]
		...
		*/
        ...
        <html lang="en">
          <head>
            ...
            <meta http-equiv="Content-Security-Policy" content="default-src 'none'; font-src ${webview.cspSource} data:; style-src ${webview.cspSource} 'unsafe-inline'; img-src ${webview.cspSource} https://storage.googleapis.com https://img.clerk.com data:; media-src ${webview.cspSource}; script-src ${webview.cspSource} 'wasm-unsafe-eval' 'nonce-${nonce}' https://us-assets.i.posthog.com 'strict-dynamic'; connect-src ${webview.cspSource} https://openrouter.ai https://api.requesty.ai https://us.i.posthog.com https://us-assets.i.posthog.com https://api-test.aiidebas.com https://api.aiidebas.com http://localhost:8000 http://127.0.0.1:8000;">
            <link rel="stylesheet" type="text/css" href="${stylesUri}">
			<link href="${codiconsUri}" rel="stylesheet" />
			<script nonce="${nonce}">
				window.IMAGES_BASE_URI = "${imagesUri}"
